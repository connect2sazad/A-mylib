<?php
    class NavbarHorizontalW3schools{
        private $lib;
        private $style;
        function __construct(){
            if(!defined("ENGINE") || !defined("__ENGINEURL__")) die("<b>navbar-horizontal-w3schools</b> requires LibLoader Engine as, <b>navbar-horizontal-w3schools</b> cannot be executed outside of LibLoader Engine.");
            if(ENGINE){
                $this->lib = file_get_contents(__ENGINEURL__."library/navbar-horizontal-w3schools/navbar-horizontal-w3schools.lib") or die();
                $this->style = file_get_contents(__ENGINEURL__."library/navbar-horizontal-w3schools/navbar-horizontal-w3schools.style") or die();
            }
        }
        ...
        function get_style(){
            $new_stylesheet = fopen('./library/navbar-horizontal-w3schools/navbar-horizontal-w3schools-style.css', "w+") or die();
            fwrite($new_stylesheet, $this->style);
            fclose($new_stylesheet);
            echo '<link rel="stylesheet" href="'.__ENGINEURL__.'library/navbar-horizontal-w3schools/navbar-horizontal-w3schools-style.css">';
